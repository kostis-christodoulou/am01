...
You can find details on [installing the tidyverse here](https://am01-sep24.netlify.app/reference/02-reference/)

## Practice using Markdown

Assignments will be submitted using `Markdown` is a lightweight text formatting language that easily converts between file formats. It is integrated directly into [Quarto Markdown](https://quarto.org/docs/get-started/hello/rstudio.html), which combines R code, output, and written text into a single document (`.qmd`). You can [find more about markdown here](https://am01-sep24.netlify.app/reference/03-reference/).

You can use a `Visual` editor, much like using word-processing software, but you can always switch back to `Source`.
